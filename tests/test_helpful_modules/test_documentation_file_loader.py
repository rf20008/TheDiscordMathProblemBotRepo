...
from helpful_modules.the_documentation_file_loader import DocumentationFileLoader, DocumentationNotFound, DocumentationFileNotFound

class TestDocumentationFileLoader(unittest.TestCase):

    @patch("builtins.open", new_callable=mock_open, read_data='{"file_name": "test.json", "contents": [{"title": "TestTitle", "contents": "TestContents"}]}')
    def test_load_documentation_into_readable_files(self, mock_open):
        ...
        self.assertEqual(documentation, [{"file_name": "test.json", "contents": [{"title": "TestTitle", "contents": "TestContents"}]}])

    @patch("builtins.open", new_callable=mock_open, read_data='{"file_name": "test.json", "contents": []}')
